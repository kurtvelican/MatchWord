...
public final class ActivitySplashScreenBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView logoTemplate;

  private ActivitySplashScreenBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView logoName, @NonNull ImageView logoTemplate) {
  ...
  public static ActivitySplashScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.logoName;
      ImageView logoName = ViewBindings.findChildViewById(rootView, id);
      if (logoName == null) {
        break missingId;
      }

      id = R.id.logoTemplate;
      ImageView logoTemplate = ViewBindings.findChildViewById(rootView, id);
      if (logoTemplate == null) {
        break missingId;
      }

      return new ActivitySplashScreenBinding((ConstraintLayout) rootView, logoName, logoTemplate);
    }
