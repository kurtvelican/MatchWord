...
public final class FragmentGameBinding implements ViewBinding {
  ...
  private FragmentGameBinding(@NonNull ConstraintLayout rootView, @NonNull Button answer2,
      @NonNull Button answer3, @NonNull Button answer4, @NonNull Button question,
  ...
  public static FragmentGameBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.question;
      Button question = ViewBindings.findChildViewById(rootView, id);
      if (question == null) {
        break missingId;
      }
      ...
      return new FragmentGameBinding((ConstraintLayout) rootView, answer2, answer3, answer4,
          question, retryButton);
    }
