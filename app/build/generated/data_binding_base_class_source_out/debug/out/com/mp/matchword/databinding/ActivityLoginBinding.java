...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull TextView forgotPassword,
      @NonNull EditText inputEmail, @NonNull EditText inputPassword, @NonNull TextView logo,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, forgotPassword, inputEmail,
          inputPassword, logo, progressBar, signInButton, textViewSignUp);
    }
